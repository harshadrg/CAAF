                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <p className="text-base sm:text-lg text-(--color-text-secondary) leading-relaxed">
                            Comprehensive governance, compliance, audit, and cybersecurity advisory services
                            designed for regulated enterprises operating in complex, high-stakes environments.
                        </p>
                    </div>

                    {/* Right: stat cluster — always left-aligned text */}
